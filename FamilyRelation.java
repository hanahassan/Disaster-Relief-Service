...
public class FamilyRelation {
    ...
    //PersonOne should be the person storing the relationship
    private DisasterVictim personOne;
    private String relationshipTo;
    //PersonTwo should be the person storing the relationship=
    ...
    public boolean checkExisting(DisasterVictim personOne, DisasterVictim personTwo) {
        ...
        return personTwo != null && personOne.hasRelation(personTwo);
    }
